...
public record RegisterCommand(string FirstName, string LastName, string Email, string Password, DateTime? DateOfBirth = null, string? Motivations = null) : IRequest<AuthResult>;
