...
public static class DependencyInjection
{
        ...
        IConfiguration config)
    {
        ...
        // Semantic Kernel — singleton Kernel com dois serviceIds mapeados para gpt-4.1-mini
        // xyla      → agente de entrevista (conversacional)
        // xyla-mini → geração de explicações (determinístico)
